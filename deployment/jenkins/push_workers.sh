...
docker tag ufaldsg/cloud-asr-worker-en-voxforge $DOCKER_REGISTRY/ufaldsg/cloud-asr-worker-en-voxforge:$BUILD_NUMBER
docker tag ufaldsg/cloud-asr-worker-en-wiki $DOCKER_REGISTRY/ufaldsg/cloud-asr-worker-en-wiki:$BUILD_NUMBER
docker tag ufaldsg/cloud-asr-worker-dummy $DOCKER_REGISTRY/ufaldsg/cloud-asr-worker-dummy:$BUILD_NUMBER
