...
docker tag ufaldsg/cloud-asr-api $DOCKER_REGISTRY/ufaldsg/cloud-asr-api:$BUILD_NUMBER
docker tag ufaldsg/cloud-asr-web $DOCKER_REGISTRY/ufaldsg/cloud-asr-web:$BUILD_NUMBER
...
docker tag ufaldsg/cloud-asr-recordings $DOCKER_REGISTRY/ufaldsg/cloud-asr-recordings:$BUILD_NUMBER
