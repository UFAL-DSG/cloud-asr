...
# source: cloudasr/shared/messages/messages.proto
...
_RECOGNITIONREQUESTMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='cloudasr.messages.RecognitionRequestMessage.type', index=0,
      number=1, type=14, cpp_type=8, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='body', full_name='cloudasr.messages.RecognitionRequestMessage.body', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='has_next', full_name='cloudasr.messages.RecognitionRequestMessage.has_next', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='frame_rate', full_name='cloudasr.messages.RecognitionRequestMessage.frame_rate', index=3,
...
_RESULTSMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='final', full_name='cloudasr.messages.ResultsMessage.final', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='alternatives', full_name='cloudasr.messages.ResultsMessage.alternatives', index=1,
...
HeartbeatMessage = _reflection.GeneratedProtocolMessageType('HeartbeatMessage', (_message.Message,), dict(
  ...
  __module__ = 'cloudasr.shared.messages.messages_pb2'
