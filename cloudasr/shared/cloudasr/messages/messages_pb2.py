...
_RECOGNITIONREQUESTMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='new_lm', full_name='cloudasr.messages.RecognitionRequestMessage.new_lm', index=5,
